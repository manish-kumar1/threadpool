...
namespace Static {
  ...
  constexpr inline const decltype(auto) schedule_request_timeout() { return std::chrono::milliseconds(100); }
  constexpr inline const decltype(auto) scheduler_tick()           { return std::chrono::milliseconds(100);  }
